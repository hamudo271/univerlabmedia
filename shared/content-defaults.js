...
export const defaults = {
  ...
  home: {
    ...
    heroSlides: {
      items: [
        {
          eyebrow: "UNIVERLAB MEDIA",
          title: "당신의 세상을\n연구합니다",
          accent: "연구",
          desc: "단순히 예쁘기만 한 영상이 아닙니다.\n소비자의 행동을 움직이는 '성과 중심' 콘텐츠를 만듭니다.",
          videoId: "XxyVUqmU6fo",
        },
        {
          eyebrow: "REAL STORY",
        ...
        {
          eyebrow: "PROVEN GROWTH",
          title: "11만 구독 채널을 직접 키운\n팀이 당신의 채널을 설계합니다",
          accent: "직접 키운",
          desc: "자기계발·뷰티·패션·요리까지.\n직접 운영하며 쌓은 데이터로 성장 구조를 만듭니다.",
          videoId: "PjwbITGTRY0",
        },
        {
          eyebrow: "WHY US",
          title: "잘 팔리는 영상에는\n분명한 '이유'가 있습니다",
          accent: "이유",
          desc: "프레임마다 명확한 기획 의도.\n심리학과 색채학 기반의 논리적인 편집.",
          videoId: "wJ-C4raAzb4",
        },
        {
          eyebrow: "ALL-IN-ONE",
  ...
  column: {
    ...
    list: {
      ...
      items: [
        {
          badge: "Trend Report",
          title: "2024년 영상 콘텐츠 트렌드 분석 리포트 Vol.1",
          desc: "숏폼 콘텐츠의 부상과 AI 기술의 발전이 미디어 산업에 미치는 영향에 대해 심도있게 분석해봅니다.",
          date: "2024.03.11",
        },
        {
          badge: "Trend Report",
          title: "2024년 영상 콘텐츠 트렌드 분석 리포트 Vol.2",
          desc: "숏폼 콘텐츠의 부상과 AI 기술의 발전이 미디어 산업에 미치는 영향에 대해 심도있게 분석해봅니다.",
          date: "2024.03.12",
        },
        {
          badge: "Trend Report",
          title: "2024년 영상 콘텐츠 트렌드 분석 리포트 Vol.3",
          desc: "숏폼 콘텐츠의 부상과 AI 기술의 발전이 미디어 산업에 미치는 영향에 대해 심도있게 분석해봅니다.",
          date: "2024.03.13",
        },
        {
          badge: "Trend Report",
          title: "2024년 영상 콘텐츠 트렌드 분석 리포트 Vol.4",
          desc: "숏폼 콘텐츠의 부상과 AI 기술의 발전이 미디어 산업에 미치는 영향에 대해 심도있게 분석해봅니다.",
          date: "2024.03.14",
        },
        {
          badge: "Trend Report",
          title: "2024년 영상 콘텐츠 트렌드 분석 리포트 Vol.5",
          desc: "숏폼 콘텐츠의 부상과 AI 기술의 발전이 미디어 산업에 미치는 영향에 대해 심도있게 분석해봅니다.",
          date: "2024.03.15",
        },
        {
          badge: "Trend Report",
          title: "2024년 영상 콘텐츠 트렌드 분석 리포트 Vol.6",
          desc: "숏폼 콘텐츠의 부상과 AI 기술의 발전이 미디어 산업에 미치는 영향에 대해 심도있게 분석해봅니다.",
          date: "2024.03.16",
        },
      ],
  ...
  contact: {
    ...
    info: {
      ...
      items: [
        ...
        { title: "Phone", value: "010-2339-9321" },
        { title: "Address", value: "서울 성동구 뚝섬로13길 38 KT&G상상플래닛 6층" },
    ...
    form: {
      ...
      projectTypePlaceholder: "선택해주세요",
      projectTypeOptions: [
        { value: "youtube", label: "유튜브 채널 운영" },
        { value: "corporate", label: "기업 홍보 영상" },
        { value: "viral", label: "바이럴/광고 영상" },
        { value: "shortform", label: "숏폼 콘텐츠" },
      ...
      budgetOptions: [
        ...
        { value: "10m_30m", label: "1,000만원 ~ 3,000만원" },
        { value: "over_30m", label: "3,000만원 이상" },
        { value: "undecided", label: "미정" },
      ],
      referenceLabel: "Reference URL (Optional)",
      referencePlaceholder: "참고할 만한 영상이나 웹사이트 주소가 있다면 남겨주세요.",
      messageLabel: "Message",
      messagePlaceholder:
        "프로젝트 내용, 목표, 일정 등 자세한 내용을 적어주시면 정확한 상담이 가능합니다.",
  ...
  global: {
    ...
    footer: {
      ...
      address: "서울 성동구 뚝섬로13길 38 KT&G상상플래닛 6층",
      contactLabel: "Contact",
      phone: "Tel: 010-2339-9321",
