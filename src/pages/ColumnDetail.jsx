...
/** Public (light-theme) styling for the rendered post HTML. */
function PostContentStyles() {
  return (
    <style>{`
      .post-content { color: #1e293b; font-size: 1.05rem; line-height: 1.85; }
      .post-content > *:first-child { margin-top: 0; }
      .post-content p { margin: 0 0 1.2em; }
      .post-content h2 { font-size: 1.6rem; font-weight: 800; color: #0b1020; margin: 1.8em 0 0.6em; }
      .post-content h3 { font-size: 1.3rem; font-weight: 700; color: #0b1020; margin: 1.5em 0 0.5em; }
      .post-content ul { list-style: disc; padding-left: 1.5em; margin: 0 0 1.2em; }
      .post-content ol { list-style: decimal; padding-left: 1.5em; margin: 0 0 1.2em; }
      .post-content li { margin: 0.35em 0; }
      .post-content blockquote { border-left: 3px solid #2563eb; padding: 0.2em 0 0.2em 1.1em; margin: 0 0 1.2em; color: #475569; font-style: italic; }
      .post-content a { color: #2563eb; text-decoration: underline; }
      .post-content img { max-width: 100%; height: auto; border-radius: 12px; margin: 1.4em 0; }
      .post-content strong { font-weight: 700; color: #0b1020; }
    `}</style>
  );
}
