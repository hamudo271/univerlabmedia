...
import { MapPin, Phone, Mail, Clock, Send, Info, CheckCircle2, Loader2 } from 'lucide-react';
...
const Contact = () => {
  ...
  return (
    <div className="bg-bg-primary">
      ...
      <FaqAccordion className="border-t border-border-primary bg-bg-secondary py-24" />
    </div>
  );
};
